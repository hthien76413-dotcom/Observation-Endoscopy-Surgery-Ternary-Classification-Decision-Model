...
FIGURES = [
 ...
 "「消化道位置」一层，届时重跑即成四段图)",
 "Fig 4. Receiver operating characteristic curves, one-versus-rest. "
 "(A) Internal validation by 5-fold cross-validation with imputation performed "
 "separately within each fold (N = 1238). (B) Temporal validation: the model "
 "fitted on 2016–2023 admissions applied unchanged to admissions after 2023 "
 "(N = 413). Areas under the curve are shown with 95% bootstrap confidence "
 "intervals from 2000 resamples of cases; class sizes are in parentheses. "
